...
public class RaceCar {
    ...
    public static RaceCar[] getDefaultCars() {
        return new RaceCar[] {
                new RaceCar("Alpha",   2, 6, 1),
                new RaceCar("Bravo",   2, 6, 0),
                new RaceCar("Charlie", 1, 8, 3),
                new RaceCar("Delta",   3, 4, 0),
                new RaceCar("Echo",    2, 8, 0),
                new RaceCar("Foxtrot", 6, 1, 3),
                new RaceCar("Golf",    4, 3, 0),
                new RaceCar("Hotel",   2, 10, -2),
                new RaceCar("India",   3, 6, -2),
                new RaceCar("Juliet",  1, 20, -5),
                new RaceCar("Kilo",    5, 2, 1),
                new RaceCar("Lima",    2, 12, -4)
        };
    }
}